...
<div class="breakout-row content_block <?php if( is_home() ) { echo 'slide_block'; } {} ?>" id="breakout-row">
		
		
		<a id="ftb_block" name="ftb_block"></a>
		
			<div class="twelve columns alpha omega aside-container">
				<div class="supertagline"> 
					<?php if(get_option_tree('homepage_breakout_title')) { ?><?php echo get_option_tree('homepage_breakout_title'); ?><?php } ?>
				</div>
			...
			<?php while (have_posts()) : the_post(); ?>
					...
					<div class="four alpha columns module-container 
