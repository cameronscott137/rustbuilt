...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/functions/plugins/wp-paginate.zip', // The plugin source
        ...
        /**array(
            *'name'                  => 'Scroll to Top', // The plugin name
            *'slug'                  => 'dynamic-to-top', // The plugin slug (typically the folder name)
            *'source'                => get_stylesheet_directory() . '/functions/plugins/dynamic-to-top.3.4.1.zip', // The plugin source
...
function init_mdnw() {
	...
	if(!is_admin()){
    	...
    	wp_register_style ( 'buttons', WP_THEME_URL . '/assets/stylesheets/buttons.css' );
		...
		wp_register_script( 'WayPoints', WP_THEME_URL . '/assets/javascripts/waypoints.min.js', false, null, true);
    ...
    register_nav_menus( array(
		'topbar' => __( 'Traditional Menu (under the scrolling pages)', 'skeleton' ),
		'topbar_small' => __( 'Responsive Menu ( a custom menu for phones)', 'skeleton' ),
	) );
	...
	register_sidebar( array(
		'name' => __( 'Sub-Menu Sidebar', 'skeleton' ),
		'id' => 'default-widget-area',
		'description' => __( 'A small widget area that fits snuggly underneath the main navigation.', 'skeleton' ),
    ...
    register_sidebar( array(
        ...
        'id' => 'calendar',
        'description' => __( 'calendar', 'skeleton' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h5 class="footer-widget-title">',
        'after_title' => '</h5>',
