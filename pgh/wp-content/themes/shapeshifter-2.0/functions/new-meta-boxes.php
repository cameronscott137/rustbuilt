...
function custom_meta_boxes() {
  ...
  $page_options = array(
	...
	array(
    	'id' => 'page_subtext',
		'label' => 'Page Menu Subtext',			
		'desc' => 'If this page is part of your scrolling homepage, enter a few words for the menu item subtext.',					
		'type' => 'text',					
		'std' => '',
		'class' => '',
      	'choices' => array()
	...
	array(
		...
		'desc' => 'Selecting Yes will hide the page title from view.',					
		'type' => 'radio',					
		'std' => '',
		'class' => '',
      	'choices'     => array( 
	...
	array(
    	'id' => 'frontpage_slider',
		'label' => 'Show the FrontPage Slider?',			
	...
	array(
    	'id' => 'widgets_hide',
		'label' => 'Hide the Widgets Row?',			
		'desc' => 'Toggle the Widgets Row element off from this option (only relevant if it is turned on in the Theme Options panel). ',					
		'type' => 'radio',					
		'std' => '',
		'class' => '',
      	'choices'     => array( 
