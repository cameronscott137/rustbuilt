...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'sections'        => array( 
      ...
      array(
        'id'          => 'landingpage_options',
        'title'       => 'Scrolling Landing Page'
      ),
      array(
        'id'          => 'frontpage',
...
<br />
<br />
You\'ll setup the scrolling navigation here in the Theme Options page, under the "<b>Scrolling Landing Page</b>" tab. The "Traditional Menu" (the second set of links that shows up below the set of scrolling pages) is setup from the "<b>Appearances &gt; Menus</b>" page in your WP dashboard. 

<br />
<br />

The Widgets area is setup from the <b>Appearances &gt; Widgets</b> page. Note that if you add too many widgets, the sidebar will stop being "fixed" and will scroll with your content.',
        'std'         => '',
      ...
      array(
        ...
        'desc'        => 'Right or Left, pick where you\'d like the sidebar to show up!',
        'std'         => '',
        'type'        => 'radio',
        'section'     => 'skin_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'default_bg',
        'label'       => 'Upload Your Background Image',
...
This is an advanced option! This is not recommended for users not fluent in CSS... but if you do know CSS, anything you add here will override the default styles.',
      ...
      array(
        'id'          => 'new_notes',
        'label'       => 'Scrolling Landing Page',
        'desc'        => 'This is the scrolling landing page that\'s seen on the theme demo. It only will appear if you have the "Settings > Reading" panel set to display "Your Latest Posts". It has it\'s own <strong>separate page navigation</strong> that you\'ll setup right here. The traditional menu (that appears below the scrolling menu) is setup from the "Appearances > Menus" panel.',
        'std'         => '',
        'type'        => 'textblock-titled',
        'section'     => 'landingpage_options',
        'rows'        => '',
        'post_type'   => '',
        'taxonomy'    => '',
        'class'       => ''
      ...
      array(
        'id'          => 'include_welcome_section',
        'label'       => 'Include the Welcome Section at the top of the Landing Page?',
        'desc'        => 'Select whether you\'d like the custom welcome section to show up at the top of the pages on the Scrolling Homepage (you\'ll customize these <b>sections below).</b><br />',
        'std'         => '',
        'type'        => 'radio',
        'section'     => 'landingpage_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'welcome_title',
        'label'       => 'Scrolling Menu : Home Link Text',
        'desc'        => 'If you selected "Yes" above, a "home" link will be created automatically. Enter the text that you\'d like to use for that link here.',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'landingpage_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'welcome_subtext',
        'label'       => 'Scrolling Menu : Home Link Sub-Text',
        'desc'        => 'Enter a few words of "subtext" for the "home" link that you just setup above.',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'landingpage_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'sidescroll_page_ids',
        'label'       => 'Pick Your Scrolling Pages',
        'desc'        => 'Pick which pages you\'d like available for the <b>Scrolling</b> portion of the menu. You can change the ordering of these by editing their "<b>Publishing Dates</b>" from the <b>Page Editor</b>. 
<br />
<br />
The optional "<b>Subtext</b>" for each item that you select can be set from the Page Editor under the Skeleton Page Options.

<br />
<br />
*<b>Page templates</b> won\'t work in the Scrolling section (ie: the Portfolio and Blog templates)! This is a WP limitation, sorry!
<br />
<br />
**Image galleries will require you to add the page ID in the gallery shortcode.
<br />
<br />
***Keep in mind: You can also add as many external pages, links, and categories as you want from your primary <b>Appearances &gt; Menus</b> panel under the <b>Traditional Menu</b> space! You can also add subtext to those pages from each menu item\'s <b>Title Attribute</b> field.',
        'std'         => '',
        'type'        => 'page-checkbox',
        'section'     => 'landingpage_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'module_padding',
        'label'       => 'How much space would you like between modules',
        'desc'        => 'Default: "500px". Enter a value if you\'d like to add vertical spacing between your modules. (ie: 400px).',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'landingpage_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'blog_scrolling',
        'label'       => 'Show the "From the Blog" row below the Scrolling content?',
        'desc'        => 'Do you want the "From the Blog" row to show up on the SideScrolling landing page? (Configurable below)',
        'std'         => '',
        'type'        => 'radio',
        'section'     => 'landingpage_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'ftb_navtitle',
        'label'       => 'Scrolling Menu : Blog Link Sub-Text',
        'desc'        => 'If you selected "Yes" to the From the Blog Row showing up on the scrolling page, give it a navigation title for the menu.',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'landingpage_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'ftb_subtitle',
        'label'       => 'Scrolling Menu : Blog Link Sub-Text',
        'desc'        => 'If you selected "Yes" to the From the Blog Row showing up on the scroll page, give it a navigation subtitle for the menu.',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'landingpage_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'widgets_scrolling',
        'label'       => 'Show the Footer Widget Space below the Scrolling Content?',
        'desc'        => 'Do you want the footer widget space to show up on the SideScrolling landing page? (Configurable below and from the Appearance &gt; Widgets panel)',
        'std'         => '',
        'type'        => 'radio',
        'section'     => 'landingpage_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'widget_navtitle',
        'label'       => 'Give the Widget row a Title...',
        'desc'        => 'If you selected "Yes" to the Widget Row showing up on the scroll page, give it a navigation title for the menu.',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'landingpage_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'widget_subtitle',
        'label'       => 'Give the Widget row a Sub-Title',
        'desc'        => 'If you selected "Yes" to the Widget Row showing up on the scroll page, give it a navigation subtitle for the menu.',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'landingpage_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'welcome_notes',
        'label'       => 'Welcome Section Options',
        'desc'        => 'This section only appears if you have your "Settings > Reading" panel set to "Your Latest Posts" and if you opted to display the welcome section in the previous tab. The welcome section is a custom layout that shows up at the top of the scrolling page as you saw in the theme demo.',
        'std'         => '',
        'type'        => 'textblock-titled',
        'section'     => 'frontpage',
        'rows'        => '',
      ...
      array(
        'id'          => 'frontpage_slider',
        'label'       => 'Welcome Section : Display Image Slider?',
      ...
      array(
        ...
        'label'       => 'Welcome Section : Display Blurb Row?',
      ...
      array(
        ...
        'label'       => 'Show FrontPage Welcome Text?',
...
Note: The theme will automatically resize any oversized images to fit the space. Images should all be roughly the same height, and images that are too small will not be scaled "up" to fit the space.',
      ...
      array(
        ...
        'desc'        => 'Selecting "Yes" will make thumbnails across the theme (including the homepage thumbnails) open the fullsize featured-image inside a lightbox. For homepage blurb images, this means the image URL. For blog posts, this can also be your "lightbox link" custom field (which can be a video URL!). /// Selecting "No" will make the thumbnails all link to their full post (inside a normal post template), or in the case of the homepage blurb images, link to their destination URL.',
        'std'         => '',
        'type'        => 'radio',
      ...
      array(
        'id'          => 'header_social',
        'label'       => 'Display Social Icons in the Top Hat?',
        'desc'        => 'Do you want the social icons to be show in the top hat section? (naturally, if you\'ve disabled the top hat, this won\'t show up). You\'ll be able to specify links for these icons later in this panel.',
        'std'         => '',
        'type'        => 'radio',
        'section'     => 'header',
        'rows'        => '',
      ...
      array(
        ...
        'label'       => 'Show The "From the Blog" Row Below Page Content?',
        'desc'        => 'Select "Yes" to show a row of posts just above the footer widgets section and below a page\'s content. You can setup custom options for it below (only necessary if you pick Yes, naturally!). Note: If you select "Yes", you can always disable this on individual Posts/Pages from the Post/Page Options box.',
        'std'         => '',
        'type'        => 'radio',
        'section'     => 'breakout',
        'rows'        => '',
      ...
      array(
        'id'          => 'footer_widgets',
        'label'       => 'Display Footer Widget Space Below Page Content?',
